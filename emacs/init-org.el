...
(setq org-capture-templates
      (quote (("t" "todo" entry (file org-refile-file-path)
               "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
              ("r" "respond" entry (file org-refile-file-path)
              ...
              ("w" "org-protocol" entry (file org-refile-file-path)
               "* TODO Review %c\n%U\n" :immediate-finish t)
              ("m" "Meeting" entry (file org-refile-file-path)
...
(defvar bh/organization-task-id "7348ca75-1689-405f-9a5e-463569771a6e")
